...
let streamLog = Logger(subsystem: "com.evensong.app", category: "streaming")
...
final class RemoteStreamingService: NSObject, @unchecked Sendable {
    private static let scheme = "evensongstream"
    ...
    private let callbackQueue = DispatchQueue(label: "Evensong.RemoteStreaming.loader")
