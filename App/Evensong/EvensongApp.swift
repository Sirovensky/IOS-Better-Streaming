...
private struct DevicePlaybackProbeView: View {
    static var isEnabled: Bool {
        ProcessInfo.processInfo.arguments.contains("--evensong-playback-probe")
    }
...
private final class DevicePlaybackProbe {
    ...
    private let streamCacheDir = FileManager.default.temporaryDirectory.appendingPathComponent("EvensongProbeRanges", isDirectory: true)
